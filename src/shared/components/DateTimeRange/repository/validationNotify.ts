...
export function validationResultKey(result: DateTimeRangeValidationResult): string {
...
export function notifyValidationIfChanged(
    ...
    lastKeyRef: MutableRef<string | null>,
...
export function shouldShowValidationOnBlur(container: HTMLElement, graceUntil: number): boolean {
